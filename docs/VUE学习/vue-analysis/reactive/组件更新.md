---
date: 2019-07-23
permalink: vue-analysis/reactive/component-update
---
# 组件更新
...
第一步：
<img :src="$withBase('/img/vue/update-children-1.png')">

第二步：
<img :src="$withBase('/img/vue/update-children-2.png')">

第三步：
<img :src="$withBase('/img/vue/update-children-3.png')">

第四步：
<img :src="$withBase('/img/vue/update-children-4.png')">

第五步：
<img :src="$withBase('/img/vue/update-children-5.png')">

第六步：
<img :src="$withBase('/img/vue/update-children-6.png')">
