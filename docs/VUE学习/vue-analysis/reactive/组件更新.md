...
第一步：
<img :src="$withBase('/img/update-children-1.png')">

第二步：
<img :src="$withBase('/img/update-children-2.png')">

第三步：
<img :src="$withBase('/img/update-children-3.png')">

第四步：
<img :src="$withBase('/img/update-children-4.png')">

第五步：
<img :src="$withBase('/img/update-children-5.png')">

第六步：
<img :src="$withBase('/img/update-children-6.png')">
