---
date: 2019-07-23
permalink: vue-analysis/compile/parse
---
# parse
...
<img :src="$withBase('/img/vue/advance-1.png')">
...
<img :src="$withBase('/img/vue/advance-2.png')">
...
<img :src="$withBase('/img/vue/stack.png')">
...
<img :src="$withBase('/img/vue/parse.png')">
